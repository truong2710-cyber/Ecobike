...
public class ElectricSingleBike extends Bike{
    ...
    public ElectricSingleBike(int bikeCode, String type, String name, String country, String date_of_manufacture, String color, int price, String license_place_number, int slot_id, int park_id, boolean is_rented, int battery, int maximum_usage_time) {
