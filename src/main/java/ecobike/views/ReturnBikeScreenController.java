...
import ecobike.views.MainScreenController;
import ecobike.views.RentBikeTransactionScreenController;
...
public class ReturnBikeScreenController implements Initializable {
    ...
    public void handleDoubleClickOnParkingLotList(){
        ...
        if(checkParkingLotFull(parkingLot)) {
            ...
            if (option.get() == ButtonType.OK){
                ...
                Card card = CardDA.getCardRentalTransaction(rental_id);
                if(card != null){
    ...
    private void showRentBikeTransactionInfo(String rental_id) {
        ...
        try {
            ...
            rentBikeTransactionScreenController.initData(rental_id);
